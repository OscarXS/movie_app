...
const Movie = () => {
  ...
  return (
    <div className='h-dvh'>
      <Navbar />
      <div className="bg-primary w-full overflow-hidden pb-40">
        <div className="flex flex-col justify-center items-center sm:px-16 px-8 py-4 relative" style={{ height: '100vh' }}>
          ...
          <div className="flex justify-center items-center sm:px-16 px-8 py-4 w-full z-10 mt-40">
            <div className="xl:max-w-[1280px] w-full flex flex-col md:flex-row gap-20 items-center sm:flex-col-reverse">
              <img className='flex-[1] object-cover object-top w-10 sm:w-1/2' src={`https://image.tmdb.org/t/p/original/${singleMovie?.poster_path}`} alt="image" />
